/**
 * @fileoverview Warp Zone Patrol Ship
 * Created with Level Editor
 */

import type { Level } from '@shared/types/Level';

export const levelWarpZonePatrolShip: Level = {
  id: 'warp-zone-patrol-ship',
  name: 'Warp Zone Patrol Ship',
  ...
  hazards: [
    {"type":"patrolShip","x":300,"y":60,"width":45,"height":45,"minY":160,"maxY":205,"speed":120,"startDirection":1,"wrap":true},
