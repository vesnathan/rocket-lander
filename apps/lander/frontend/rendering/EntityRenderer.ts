...
export function renderSpawnBubble(
  ...
  // color is a valid key, but noUncheckedIndexedAccess requires this check
  const colors = SPAWN_BUBBLE_COLORS[color] ?? { fill: 0x00ff00, stroke: 0x00aa00 };
